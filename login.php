                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" class="form-group">
                            <div>
                                ...
                                <div class="input-group form-group">
                                    ...
                                    <input type="text" class="form-control input-lg" name="login" placeholder="Nom Utilisateur / Email">
                                </div>
                            ...
                            <div style="position: relative; top: 20px;">
                                ...
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control input-lg" type="password" name="mot-de-passe" placeholder="Mot de passe">
                                </div>
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary btn-lg pull-left" type="submit" style="width: 160px;">Entrer</button>
