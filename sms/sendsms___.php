                    ...
                    <form method="get" action="authsms.php">
                        <div class="col-md-6 form-line">
                            <div class="form-group">
                                ...
                                <input type="text" name="sender" class="form-control" id="" placeholder=" Nom de l'expéditeur">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail">No Destinataire(s)</label>
                                <input type="tel" name="recipient" class="form-control" id="exampleInputEmail" placeholder=" Numéro(s) du destinataire">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="message" class="form-control" id="description" placeholder="Entrer votre Message" rows="6"></textarea>
                            </div>
                            <div>
